...
/// Информация об идентичности для передачи во внешний интерфейс (Flutter/Tauri).
/// 
/// # Безопасность
/// Поле `mnemonic` содержит чувствительные данные и автоматически
/// обнуляется при освобождении памяти благодаря `Zeroizing`.
