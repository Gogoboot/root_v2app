...
//
// libp2p, Gossipsub, mDNS, WebSocket, DNS
// ============================================================
...
// P2pOutMessage удалён — заменён на NodeCommand::Publish
pub use channels::{P2pMessage, NodeCommand, PeerInfo, start_node_channels};
